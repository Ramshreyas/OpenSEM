...
The best way to learn is by doing. We have prepared Jupyter Notebooks that allow you to experiment with the OpenSEM API directly.
...
*   **Setup**: Importing OpenSEM libraries.
